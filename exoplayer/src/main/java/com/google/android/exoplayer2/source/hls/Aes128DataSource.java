...
//    byte z = encryptionKey[0];
//    byte y = encryptionKey[12];
//    encryptionKey[12] = z;
//    encryptionKey[0] = y;
//    System.out.println(encryptionKey.length);
//    if (w){
//      for (byte b :encryptionKey){
//        Log.i("Cand",String.valueOf(b));
//      }
//      w = false;
//    }
//    this.encryptionKey  = new byte[] { 73, 17, 47, -77, -90, -115, 101, 58, -121, 42, -122, 112, 74, -82, 55, -120};
